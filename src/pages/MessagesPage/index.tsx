      ...
      <div className="flex flex-col flex-1 h-full min-h-0 overflow-hidden bg-white border shadow-sm border-slate-200 rounded-2xl md:flex-row">
        ...
        >
          ...
          <div className="p-3 bg-white border-b border-slate-200 shrink-0">
            <div className="grid grid-cols-2 gap-2 p-1.5 bg-slate-100/80 border border-slate-200 rounded-xl">
              <button
                ...
                className={`flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg text-xs font-bold transition-all border ${
                  activeTab === 'user_support'
                    ...
                    : 'border-slate-200 text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg text-xs font-bold transition-all border ${
                  activeTab === 'dispute_chat'
                    ? 'bg-white text-red-600 border-slate-200 shadow-sm'
                    : 'border-slate-200 text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'
                }`}
              >
        ...
        {activeGroup ? (
          ...
          <div className="flex-col items-center justify-center flex-1 hidden md:flex bg-slate-50/50">
            ...
            <p className="max-w-sm text-center text-slate-500 leading-5">
